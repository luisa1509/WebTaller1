...
function renderProducts(list) {
  ...
  list.forEach(function (elem) {
    ...
    const url =`producto.html?${elem.id}`;
    ...
    <div class="product__info">
      ...
      <button class="product__delete btn hidden">Eliminar</button>
      <button class="product__edit btn hidden">Editar</button>
    ...
    cartBtn.addEventListener('click', function (event) {
      ...
      if (userInfo) {
        ...
        alert("Inicie sesion o registre");
      }
